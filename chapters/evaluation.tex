...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/results/variable_computational_demand/none_combined_slo_values.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/results/variable_computational_demand/none_combined_quality_metrics.pdf}
