...
elastic resources of centralized data centers, edge devices are highly heterogeneous,
...
processing parameters to match workload and resource conditions.
    \item Leverage active inference (AIF), to govern elasticity and ensure continuous,
adaptive fulfillment of SLOs.
