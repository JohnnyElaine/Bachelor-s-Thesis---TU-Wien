...
\caption{(Variational) Free energy as an upper bound on surprise. (taken from \cite{parr_active_2022})}
\label{fig:fe-surprise-relationship}
\end{figure}