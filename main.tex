...
\settitle{\thesistitle}{Elastic Self-Adaptive Edge Pipelines} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
\setsubtitle{Upholding Service Level Objectives through Active Inference in Distributed Stream Processing Systems on the Edge}{Upholding Service Level Objectives through Active Inference in Distributed Stream Processing Systems on the Edge} % Sets English and German version of the subtitle (both can be English or German).
