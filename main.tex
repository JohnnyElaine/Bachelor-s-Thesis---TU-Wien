...
\newcommand{\thesistitle}{Toward Self-Adaptive Edge Pipelines} % The title of the thesis. The English version should be used, if it exists.
...
\setfirstassistant{Dr.}{Boris Sedlak}{}{male}
...
\settitle{\thesistitle}{Toward Self-Adaptive Edge Pipelines} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
\setsubtitle{Optional Subtitle of the Thesis}{Upholding Service Level Objectives and Quality of Experience via Active Inference in Distributed Stream Processing Systems} % Sets English and German version of the subtitle (both can be English or German).
